...
public class Program {
        public static void main(String[] args) {
                ...
                Medico m1 = new Medico("87654321", "Dr. Luis", "Sanchez", "Vera", new java.util.Date(),
                                       "999111222", "luis@med.com", "CMP123", "RNE456", esp, new java.util.Date(),
                                       "firma_digital_xyz", null, false);
                medicoDAO.save(m1);
                System.out.println("  -> Medico guardado con CMP: " + m1.getCmp());
                /*
                 * System.out.println("\n4. Insertando Tratamiento...");
                 * Tratamiento t1 = new Tratamiento(4, TipoTratamiento.PREVENTIVO,
                 * "Tomar paracetamol", new java.util.Date(), new java.util.Date(), false);
                 * tratamientoDAO.save(t1);
                 * System.out.println("  -> Tratamiento guardado (ID): " +
                 * t1.getIdTratamiento());
                 */
                ...
                if (pLoaded != null)
                        System.out.println("Especialidad leida BD -> ID: " + pLoaded.getIdEspecialidad() + " | Nombre: "
                                        + pLoaded.getNombreEspecialidad());
                String cmpMedicoABuscar = m1.getCmp() != null ? m1.getCmp() : "CMP123";
                Medico mLoaded = medicoDAO.load(cmpMedicoABuscar);
                if(mLoaded != null) System.out.println("Medico leido BD -> CMP: " + mLoaded.getCmp() + " | Nombres: " + mLoaded.getNombres());
                ...
                if (pLoaded != null) {
                        ...
                        System.out.println("  -> Nombre de especialidad actualizado en BD a: "
                                        + pLoaded.getNombreEspecialidad());
                }
